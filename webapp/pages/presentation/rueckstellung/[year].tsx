...
export default function Rueckstellungen(props: InitialProps){
    ...
    const getTableContent = () => {
        ...
        return props.data.map((rowobj, idx) => {
            ...
            let allempty = row.every((v: any) => v === null ) || ( row[1] == 0 && row[2] == 0 && row[4] == 0 && row[5] == 0 && row[6] == 0 );
    ...
    return(
        <div className="presentation-page" style={{zoom: (props.scale)? 0.6: 1, ['MozTransform' as any]: (props.scale)? "scale(0.45)": "scale(1)", transformOrigin: `0 0`, height: (props.scale)? 300: ""}}>
