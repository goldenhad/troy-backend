    ...
    const getTableContent = () => {
        ...
        return props.data.map((rowobj, idx) => {
            ...
            if(!allempty){
                ...
                return(<div key={idx} className={"horizontalspacer"}></div>);
            }
        });
        ...
        <div className="presentation-page">
            <div className="tablestructure">
                <div className="tableheadlinerow">
                    <div className="tablecellwide">Vermögens- und Finanzlage</div>
                    <div className="tablecell tablecellspacer"></div>
                    <div className="tablecell rightallign">{currentYear.toString()[0]}{currentYear.toString()[1]}</div>
                    <div className="tablecell leftallign">{currentYear.toString()[2]}{currentYear.toString()[3]}</div>
                    <div className="tablecell tablecellspacer"></div>
                    <div className="tablecell rightallign">{(currentYear-1).toString()[0]}{(currentYear-1).toString()[1]}</div>
                    <div className="tablecell leftallign">{(currentYear-1).toString()[2]}{(currentYear-1).toString()[3]}</div>
                    <div className="tablecell tablecellspacer"></div>
                    <div className="tablecell" style={{textAlign: "center", justifyContent: "center", paddingLeft: 10}}>Veränderung</div>
                </div>
